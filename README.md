...
Если вам нравится CleanPlayer и вы хотите поддержать развитие проекта, вы можете отправить чаевые на мой криптовалютный кошелек Trust Wallet:

**Trust Wallet Tether (ERC20):** `[0xAc4723991cC038dFb322653336b335ECcc97B2E6]`

Любая поддержка очень мотивирует развивать плеер, улучшать архитектуру и добавлять новые фичи! Спасибо! 
```
---
